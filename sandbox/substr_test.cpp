...
int main() {
  ...
  std::string test1 = make_random_string(10);
  std::string test2 = make_random_string(15);

  std::cout << "test1 : " << test1 << ", " << ft_upper(test1) << '\n';
  std::cout << "test2 : " << test2 << ", " << ft_upper(test2) << '\n';
  std::cout << "test3 : " << make_random_string(20) << '\n';
}